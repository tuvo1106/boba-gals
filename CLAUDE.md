...
| `docs/api/` | *Does not exist yet.* ADR-0002 expects rswag to generate it from the request specs; build step 4 shipped without it. When it lands: **never hand-edit**. |
